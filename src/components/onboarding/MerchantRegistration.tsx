...
//                         required={true}
//                         isAutoFilled={autoFilledFields.has('business_name')}
//                     />
...
//                 <div className="grid md:grid-cols-2 gap-6">
//                     <DocumentUploadCard
//                         title="Business Proof - (Any One)"  // ✅ Updated title
//                         icon={Building}
//                         file={businessProof}
//                         uploadStatus={businessProof ? 'success' : 'idle'}
//                         ocrStatus="idle"
//                         onUpload={handleDocUpload('business')}
//                         description="Upload any one business proof"  // ✅ Updated description
//                         requirements={[  // ✅ ADDED requirements array
//                             "Shop & Establishment certificate issued by a civic Authority",
//                             "Import/Export Certificate in the name of Proprietory Firm",
//                             "Trade License issued by the local authority in the name of the proprietor containing address of the firm",
//                             "Udyam Registration Certificate (URC)",
//                             "Utility Bills - Electricity, Water and Gas bill"
//                         ]}
//                     />
...
//                         description="Upload 6 months statement"  // ✅ Updated description
//                         requirements={[  // ✅ ADDED requirements array

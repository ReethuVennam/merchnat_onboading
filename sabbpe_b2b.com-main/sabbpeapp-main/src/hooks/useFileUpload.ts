...
export const useFileUpload = () => {
    ...
    const uploadFile = useCallback(async (
        ...
        try {
            console.log('📤 Uploading file to Supabase:', { bucket, path, fileName: file.name, fileSize: file.size });
            ...
            const errorMessage = err?.message || (error instanceof Error ? error.message : 'Upload failed');
            
            console.error('❌ Upload failed:', { error: err, message: errorMessage });

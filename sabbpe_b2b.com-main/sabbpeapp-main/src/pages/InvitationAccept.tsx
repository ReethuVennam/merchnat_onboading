    ...
    const handleAcceptInvitation = async () => {
        ...
        try {
            ...
            if (authData.user) {
                ...
                toast({
                    title: "Welcome!",
                    description: "Your account has been created. Let's complete your onboarding."
                });

                // Navigate to distributor merchant onboarding with state
                navigate('/distributor/merchant-onboarding', {
                    state: {
                        merchantUserId: authData.user.id,
                        merchantEmail: email,
                        merchantPassword: password,
                        merchantName: invitation.merchant_name,
                        distributorId: invitation.distributor_id,
                        merchantProfileId: profileData?.[0]?.id
                    }
                });
            }
        } catch (err: unknown) {
